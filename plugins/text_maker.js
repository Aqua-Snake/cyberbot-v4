...
let td = Config.WORKTYPE == 'public' ? false : true
    ...
    Asena.addCommand({pattern: 'text_maker', fromMe: td, desc:TEXT_MAKER}, (async (message, match) => {    

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://xteam.xyz/textpro/helloweenfire?text=Asena%20%20%20%20%20%20%20%20%20Made%20By%20Toxic%20Devil&APIKEY=ab9942f95c09ca89`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({pattern: 'glitch ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'blackpink ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'wood ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: '8bit ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    Asena.addCommand({pattern: 'shadow ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
  ...
  await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'underwater ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'flower ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'burn ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'candy ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'halloween ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'sparkling ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    Asena.addCommand({pattern: 'watercolour ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'ninjalogo ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'neonlight ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'sandwriting ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'cloud ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'pornhub ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg , caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'snow ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: 'grass ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'candlemug ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'romance ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'lovemsg ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'blood ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made By CyberBot'})
    ...
    Asena.addCommand({pattern: '3dtext ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
